...
class Student:
    ...
    def compute_feeling_score(self):
        ...
        counter = {}
        start = 1
        num_feeling = len(self.feeling_report['class_feeling'])
        ...
        grade = self.grade_score
        activity = self.completion_score
        attendance = self.attendance_score
